...
public class UserThree implements ActionListener,Runnable
{
    ...
    UserThree()   // Constructor helps in instantiating objects of Global declarations and Furthermore, it helps in setting up the GUI
    {
        panel1 = new JPanel();
        f2.setLayout(null);
    ...
    public void actionPerformed(ActionEvent e) {
        String out =  "<html><p>" + "Idrees"+ "</p><p>" + t1.getText() + "</p></html>";
