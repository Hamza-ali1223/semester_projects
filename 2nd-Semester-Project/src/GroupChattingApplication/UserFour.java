...
public class UserFour implements ActionListener,Runnable
{
    ...
    UserFour()   // Constructor helps in instantiating objects of Global declarations and Furthermore, it helps in setting up the GUI
    {
        panel1 = new JPanel();
        f2.setLayout(null);
        ...
        ImageIcon i2 = new ImageIcon(ClassLoader.getSystemResource("icons\\4.png"));
        Image PFP = i2.getImage().getScaledInstance(50, 50, Image.SCALE_DEFAULT);
    ...
    public void actionPerformed(ActionEvent e) {
        String out =  "<html><p>" + "Wahaj"+ "</p><p>" + t1.getText() + "</p></html>";
